...
public class MPermissionUtils {
    ...
    private static void requestPermissions(Object object, int requestCode
        ...
        mRefOnPermissionListener = new WeakReference<OnPermissionListener>(callback);
//        mOnPermissionListener = callback;

        if(checkPermissions(getContext(object), permissions)){
            if(mRefOnPermissionListener.get() != null)
                mRefOnPermissionListener.get().onPermissionGranted();
        }else{
    ...
    public static void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        if(requestCode == mRequestCode){
            if(verifyPermissions(grantResults)){
                ...
                if(mRefOnPermissionListener.get() != null) {
                    mRefOnPermissionListener.get().onPermissionDenied();
                }
            }
        }
    }
    ...
    private static Reference<OnPermissionListener> mRefOnPermissionListener;
}
